...
# --- Configuration ---
MODEL_OPTIONS = {
    "ANPR (Automatic Number Plate Recognition)": r"C:\Users\patel\OneDrive\Documents\Desktop\ANPR_ATCC\ANPR_ATCC-main\ANPR_ATCC-main\streamlit_app\yolo_ANPR.pt",
    "ATCC (Traffic Count & Classification)": r"C:\Users\patel\OneDrive\Documents\Desktop\ANPR_ATCC\ANPR_ATCC-main\ANPR_ATCC-main\streamlit_app\yolo_ATCC.pt",
}
...
def process_video_mode(uploaded_file, model, ocr_model, is_anpr, conf):
    ...
    cap.release()
    out.release()
    cv2.destroyAllWindows()  # Optional, closes OpenCV windows
    progress_bar.empty()
    status_text.empty()
    # Safe File Removal
